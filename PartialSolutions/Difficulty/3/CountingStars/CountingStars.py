...
def findStar(curr_x, curr_y, w, h, star = set()):
		...
		for x, cell in enumerate(row):
			if cell == "-":
				...
				for star in stars:
					...
					stars.append(findStar(x,y,width,height, star = set()))
